...
(function ($) {
    ...
    $.fn.DtGrid.lang['zh-cn'] = {
        ...
        pageInfo: {
            //nothing: '无查询记录...',
            nothing: '<ul class="pagination pagination-sm dt-grid-pager-button"><li><a class="red">无数据...</a></li></ul>',
            info: '{recordCount}条记录，共{pageCount}页 {pageSize}',
            //info: '<ul class="pagination pagination-sm dt-grid-pager-button"><li><a>{recordCount}条数据</a></li><li><a class="pageSize-a">{pageSize}</a></li><li><a>共{pageCount}页</a></li></ul>',
